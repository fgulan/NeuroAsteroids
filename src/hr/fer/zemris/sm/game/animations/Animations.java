...
import static hr.fer.zemris.sm.game.Constants.STAR_ANIMATION_PATH;
...
public class Animations {
    ...
    public static Animation starRotation(ImageView imageView, Duration duration, int width, int height, int cycle) {
        imageView.setImage(starImage);
        final Animation animation =new SpriteAnimator(imageView, duration, 60, 0, width, height);
