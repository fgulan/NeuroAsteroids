...
import hr.fer.zemris.sm.evolution.ProbabilityOPeratorBag;
...
import hr.fer.zemris.sm.evolution.representation.neuralNet.ICrossover;
...
import hr.fer.zemris.sm.evolution.representation.neuralNet.SlowCrossover;
import hr.fer.zemris.sm.evolution.representation.neuralNet.genotype.ConnectionGenotype;
import hr.fer.zemris.sm.evolution.representation.neuralNet.mutation.AddNodeMutation;
import hr.fer.zemris.sm.evolution.representation.neuralNet.mutation.AddOrEnableConnectionMutation;
import hr.fer.zemris.sm.evolution.representation.neuralNet.mutation.AllWeightGaussianMutation;
