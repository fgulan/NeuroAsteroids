...
public class AsteroidesEvaluator implements IEvaluator {
    ...
    public double evaluate(IPhenotype phenotype) {
        NeuralInputController controller = new NeuralInputController(phenotype);
        world = new SimulationWorld(800, 600, 20, controller);
        world.initialize();
        world.play();
    ...
    private class NeuralInputController implements IController {

        private IPhenotype phenotype;

        private double fittness = 0;

        public NeuralInputController(IPhenotype phenotype) {
