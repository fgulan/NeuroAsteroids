...
public class StartMenu extends Menu {
    ...
    private VBox createButtons() {
        ...
        buttons.setId(START_MENU_BUTTONS_DIV);
    ...
    private Button createTrainMenu() {
        Button train = new KeyEventButton(TRAIN_BUTTON_TEXT);
        train.setId(TRAIN_BUTTON);
        train.setOnAction( e-> {
    ...
    private Button createExitMenu() {
        Button exit = new KeyEventButton(EXIT_BUTTON_TEXT);
    ...
    private Button createCreditsMenu() {
        Button credits = new KeyEventButton(CREDITS_BUTTON_TEXT);
        credits.setId(CREDITS_BUTTON);
    ...
    private Button createOptionsMenu() {
        Button options = new KeyEventButton(OPTIONS_BUTTON_TEXT);
        options.setId(OPTIONS_BUTTON);
    ...
    private Button createScoresButton() {
        Button scores = new KeyEventButton(SCORES_BUTTON_TEXT);
        scores.setId(SCORES_BUTTON);
